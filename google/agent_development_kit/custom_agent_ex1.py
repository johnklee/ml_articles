...
async def main():
  ...
  session = await call_agent_async("a lonely robot finding a friend in a junkyard")
  print(f'Story:\n{session.state["current_story"]}\n\n')
  print(f'Grammar: {session.state["grammar_suggestions"]}')
  print(f'Tone: {session.state["tone_check_result"]}\n\n')
